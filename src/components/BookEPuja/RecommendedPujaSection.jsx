...
//                 <div className="flex flex-col sm:flex-row items-start sm:items-end justify-between mb-12 gap-4 border-b border-white/10 pb-6 w-full">
//                     <div className="space-y-2 text-left">
//                         <h2 className="text-3xl sm:text-4xl md:text-5xl text-[#7a1c1c] tracking-tight font-extrabold font-serif relative inline-block pb-2">
//                             Recommended Puja
//                             <span className="absolute bottom-0 left-0 w-24 h-1 bg-[#df972b] rounded-full"></span>
//                         </h2>
...
//                     <Link
//                         to="/pooja-booking"
//                         className="group inline-flex items-center gap-2.5 bg-gradient-to-r from-[#df972b] to-[#c27803] hover:from-[#c27803] hover:to-[#df972b] text-white font-bold px-7 py-3 rounded-md text-sm transition-all duration-300 shadow-lg hover:shadow-amber-500/25 hover:scale-105 shrink-0"
//                     >
    ...
    return (
        <section className="w-full bg-gradient-to-r from-white via-[#fff7ed] to-[#fff3df]  md:px-10 relative overflow-hidden">
            <div className="max-w-7xl mx-auto relative z-10">
                ...
                {/* Header Section - Center Title with Right Button */}
