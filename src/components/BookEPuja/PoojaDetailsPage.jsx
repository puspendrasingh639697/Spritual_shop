...
// import PoojaDetailsSection from "../components/PoojaDetailsSection";

// function PoojaDetailsPage() {
//     const { id } = useParams();
//     const navigate = useNavigate();
//     const { singlePuja, loading, error, fetchPujaById } = usePujaStore();
...
//     const handleSubmit = (packageId, memberNames) => {
//         console.log("Booking Details:");
//         console.log("Package ID:", packageId);
//         console.log("Members:", memberNames);

//         // Yahan tum apna booking API call kar sakte ho
//         // Jaise: axios.post('/api/book', { packageId, memberNames })

//         alert(`Booking Confirmed for ${memberNames.length} member(s)!`);
        
//         // Optional: Booking ke baad navigate karo
//         // navigate('/booking-success');
//     };

//     if (loading) {
//         return <div className="text-center py-20 text-red-800 font-bold text-lg">Loading sacred puja details...</div>;
//     }

//     if (error) {
//         return <div className="text-center py-20 text-red-600 font-semibold">Error: {error}</div>;
//     }

//     if (!singlePuja) {
//         return <div className="text-center py-20 text-gray-500">Puja not found.</div>;
//     }

//     return (
//         <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
//             {/* ✅ handleSubmit prop pass kiya */}
//             <PoojaDetailsSection 
//                 poojaDetails={singlePuja} 
