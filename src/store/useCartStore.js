...
// //     // Agar ProductDetails se (userId, productId, quantity) bheja gaya hai
// //     if (typeof productOrId === 'string' && productOrId.length > 10 && typeof quantityOrId === 'string' && quantityOrId.length > 10) {
// //       specificUserId = productOrId;
// //       productId = quantityOrId;
// //       quantity = Number(thirdParam) || 1;
// //     } else if (typeof productOrId === 'string' && productOrId.length < 10) {
// //       // Agar galti se pehla parameter hi ID ya number aa gaya
// //       productId = quantityOrId;
// //       quantity = Number(productOrId) || 1;
// //     } else {
// //       // Normal object pass hua hai (jaise product card se)
// //       const product = productOrId || {};
// //       quantity = Number(quantityOrId) || 1;
// //       productId = product._id || product.id;
// //     }

// //     // Safety check: Agar productId abhi bhi "1" ya number hai, toh error mat bhejo
...
//     // 1️⃣ Sabse pehle check karo ki kya object pass hua hai, agar haan toh usme se ID nikalo
//     if (productOrId && typeof productOrId === 'object') {
//       productId = productOrId._id || productOrId.id;
//       quantity = Number(quantityOrId) || 1;
//     } 
//     // Agar ProductDetails se (userId, productId, quantity) bheja gaya hai
//     else if (typeof productOrId === 'string' && productOrId.length > 10 && typeof quantityOrId === 'string' && quantityOrId.length > 10) {
//       specificUserId = productOrId;
//       productId = quantityOrId;
//       quantity = Number(thirdParam) || 1;
//     } 
//     // Agar pehla parameter ID string hai aur doosra quantity number hai
//     else if (typeof productOrId === 'string') {
//       productId = productOrId;
//       quantity = Number(quantityOrId) || 1;
//     }

//     // 2️⃣ Safety Check: Agar ID abhi bhi nahi mili ya "1" hai toh yahin rok do
...
//     // 🔄 UPDATE QUANTITY (Supports both: updateQuantity(productId, quantity) OR updateQuantity(userId, productId, quantity))
//     updateQuantity: async (arg1, arg2, arg3) => {
//         let userId, productId, quantity;

//         // Smart parameter mapping to prevent argument mismatch
//         if (arg3 !== undefined) {
//             userId = arg1;
//             productId = arg2;
//             quantity = arg3;
...
//     // 🗑️ REMOVE FROM CART (Supports both: removeFromCart(productId) OR removeFromCart(userId, productId))
